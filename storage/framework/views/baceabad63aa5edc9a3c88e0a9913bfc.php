...
<?php if($tag === 'button'): ?>
    <button type="<?php echo e($type); ?>" <?php echo e($attributes->class([$buttonClasses])); ?>>
        <?php echo e($slot); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\awarebox-backend\vendor\filament\filament\src\/../resources/views/components/tabs/item.blade.php ENDPATH**/ ?>