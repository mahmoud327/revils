...
} elseif ($_instance->childHasBeenRendered('EopAmTI')) {
    $componentId = $_instance->getRenderedChildComponentId('EopAmTI');
    $componentTag = $_instance->getRenderedChildComponentTagName('EopAmTI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EopAmTI');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('EopAmTI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('G32dVBu')) {
    $componentId = $_instance->getRenderedChildComponentId('G32dVBu');
    $componentTag = $_instance->getRenderedChildComponentTagName('G32dVBu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('G32dVBu');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('G32dVBu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\awarebox-backend\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>