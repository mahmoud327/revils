...
} elseif ($_instance->childHasBeenRendered('XEayd77')) {
    $componentId = $_instance->getRenderedChildComponentId('XEayd77');
    $componentTag = $_instance->getRenderedChildComponentTagName('XEayd77');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XEayd77');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('XEayd77', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH D:\Programing\awarebox\awarebox-backend\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>