...
return [
    ...
    */
    ...
    'products' => [
        'added' => 'added product sucessfully',
        'updated' => 'updated product sucessfully',
        'deleted' => 'deleted product sucessfully',

        'rates' => [
            'rated' => 'rate is sucessfully',
        ]
    ...
    'address' => [
        'added' => 'added address sucessfully',
        'updated' => 'updated address sucessfully',
        'deleted' => 'deleted address sucessfully',
    ],
    'carts' => [
        'empty' => 'cart is empty must',

    ],
    'orders' => [
        'added' => 'order added sucessfully',
